            ...
            <nav className="lg:hidden">
                <div className="flex py-6 justify-between items-center px-4">
                    <div>
                        ...
                        >
                            <path
                                d="M0 39.4521V12.0548H12.8311C18.8007 12.0548 22.0257 16.0959 22.0257 20.8904C22.0257 25.6849 18.7321 29.726 12.8311 29.726H5.83234V39.4521H0ZM16.1247 20.8904C16.1247 18.5617 14.4093 17.1918 12.0764 17.1918H5.83234V24.5891H12.0764C14.3407 24.5891 16.1247 23.1507 16.1247 20.8904Z"
                                fill="#032E47"
                            />
                            <path
                                d="M25.6621 39.4521V12.0548H31.5631V39.4521H25.6621Z"
                                fill="#032E47"
                            />
                            <path
                            ...
                            />
                            <path
                                d="M44.6688 39.4521C42.13 32.9452 39.5913 26.4384 37.1211 19.9315C40.895 24.3151 44.6002 28.6986 48.3741 33.1507C49.6092 35.274 50.8442 37.3973 52.0107 39.4521H44.6688Z"
                                fill="#032E47"
                            />
                            <path
                                d="M63.1953 25.8219C63.1953 17.5343 69.2335 11.6439 77.536 11.6439C85.8385 11.6439 91.8767 17.5343 91.8767 25.8219C91.8767 34.1096 85.8385 40 77.536 40C69.2335 40 63.1953 34.1096 63.1953 25.8219ZM85.9071 25.8219C85.9071 20.685 82.6136 16.8493 77.536 16.8493C72.4584 16.8493 69.2335 20.685 69.2335 25.8219C69.2335 30.8904 72.4584 34.7945 77.536 34.7945C82.6136 34.7945 85.9071 30.8904 85.9071 25.8219Z"
                                fill="#032E47"
                            />
                            <path
                            ...
                            />
                            <path
                                d="M101.139 39.4521V17.1918H93.1113V12.0548H115V17.1918H107.04V39.4521H101.139Z"
                                fill="#032E47"
                            />
                            <path
