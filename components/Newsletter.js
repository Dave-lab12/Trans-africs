...
import women from '/public/africa-removebg-preview.png'
...
export default function Newsletter() {
    return (
        <>
            ...
            <div className=" relative p-6 container md:w-2/3 xl:w-auto mx-auto  flex flex-col xl:items-stretch justify-between xl:flex-row">
                ...
                <img src={women.src} className=" md:visible absolute -top-10 md:w-1/5 w-3/4 " />
                <div className="w-full xl:w-1/2 xl:pl-40 xl:py-28 ">
                    ...
                    <p className="text-base leading-normal text-gray-600 text-center xl:text-left">Write your email below to subscribe to our news letter</p>
